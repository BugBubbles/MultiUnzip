...
class MultiUnzip:
    ...
    def dump_str(self, filename: str, id_proc: int) -> None:
        ...
        with open(os.path.join(self.output_path, "failure.txt"), "a") as f:
            print(
                f"Dump process {id_proc} has accumulated {fail_write_line_num} failure write lines",
                file=f,
                flush=True,
            )
...
file_path = "/mnt/cos/cos_shanghai_2/raw_datasets/mt/p3/p1/202211.zip"
password = passwords[os.path.basename(file_path)]
# file_path = "/data_turbo/home/chenbofei/code/test_data.zip"
# password = b"test_password"
output_path = "/mnt/cos/cos_shanghai_1/raw_datasets/mt_unzip"
if __name__ == "__main__":
    ...
    min_byte_size = args.min_byte_size * 1024 if args.min_byte_size != None else 0
